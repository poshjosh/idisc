...
public class AddfeedhitTest extends LoginBase {
    ...
    public void test(int feedid) throws ServletException, IOException, ParseException {
        ...
        Object output = this.execute("/index.jsp", "feedid="+feedid+"&hittime="+hittime+"&installationid=2&installationkey=abdb33ee-a09e-4d7d-b861-311ee7061325&limit=20&format=application/json&tidy=true", "/"+name);
