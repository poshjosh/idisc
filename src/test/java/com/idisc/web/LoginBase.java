 ...
 * @author Josh
 */
public class LoginBase extends IdiscWebappSetup {
...
log("... ... ... ... ... ... ...Waiting for "+AppAuthenticationSession.class.getName());        
        AppAuthenticationSession authSess = this.waitForAuthSession(appContext, maxWait, timeUnit);
log("... ... ... ... ... ..Done waiting for "+AppAuthenticationSession.class.getName()+", session: "+authSess);

        if(authSess == null) {
            throw new ServletException("Failed to initialize "+AppAuthenticationSession.class.getName()+" even after waiting for "+maxWait+" "+timeUnit);
        }
