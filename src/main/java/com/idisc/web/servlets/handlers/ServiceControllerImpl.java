...
public class ServiceControllerImpl extends RequestHandlerProviderImpl implements ServiceController {
  ...
  private transient static final Logger LOG = Logger.getLogger(ServiceControllerImpl.class.getName());
  ...
  public void process(
      ...
      try{
        ...
        if(LOG.isLoggable(Level.FINE)){
            LOG.log(Level.FINE, "Processing request for: {0}", paramName);
        }
        ...
        if(LOG.isLoggable(Level.WARNING)){
            LOG.log(Level.WARNING, "Error processing request for: "+paramName, e);
        }
  ...
  public void processResponse(
    ...
    LOG.log(Level.FINER, "Response handler: {0}", responseHandler);
  ...
  public void processResponseAsync(
    ...
    if(sendResponse) {
      ...
      if(this.prepareResponse(responseHandler, request, response, paramName, paramValue)) {
        ...
        LOG.finer(() -> "HTML response: "+htmlResponse+", URI: " + requestURI);
        ...
        if(htmlResponse) {
          ...
          try{
            ...
            LOG.log(Level.FINE, "{0}", thrownIfAlreadyCompleted.toString());
          }
        }
      }
    }
  ...
  public boolean prepareResponse(
    ...
    if(!response.isCommitted()) {
        ...
        LOG.warning(() -> "Response already committed for session. ID: " + sessionId +
  ...
  public RequestHandler getRequestHandler(final HttpServletRequest request, RequestHandler outputIfNone) throws ServletException {
    ...
    LOG.log(Level.FINER, "Request Handler: {0}", output);
