...
public class RequestParameters extends HashMap<String, String> {
  ...
  private transient static final Logger LOG = Logger.getLogger(RequestParameters.class.getName());
  ...
  private void init(HttpServletRequest request) {
    ...
    while (en.hasMoreElements()) {
      ...
      if(value != null) {
        ...
        if(LOG.isLoggable(level)) {     
          LOG.log(level, "{0} = {1}", new Object[]{name, values==null?null:Arrays.toString(values)});
        }      
